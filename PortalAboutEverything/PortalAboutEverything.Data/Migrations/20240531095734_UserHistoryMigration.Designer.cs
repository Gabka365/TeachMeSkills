...
namespace PortalAboutEverything.Data.Migrations
{
    ...
    [Migration("20240531095734_UserHistoryMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HistoryEventUser", b =>
                {
                    b.Property<int>("FavoriteHistoryEventsId")
                        .HasColumnType("int");

                    b.Property<int>("UserWhoFavoriteTheHistoryEventId")
                        .HasColumnType("int");

                    b.HasKey("FavoriteHistoryEventsId", "UserWhoFavoriteTheHistoryEventId");

                    b.HasIndex("UserWhoFavoriteTheHistoryEventId");

                    b.ToTable("HistoryEventUser");
                });
            ...
            modelBuilder.Entity("PortalAboutEverything.Data.Model.HistoryEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HistoryEventUser", b =>
                {
                    b.HasOne("PortalAboutEverything.Data.Model.HistoryEvent", null)
                        .WithMany()
                        .HasForeignKey("FavoriteHistoryEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PortalAboutEverything.Data.Model.User", null)
                        .WithMany()
                        .HasForeignKey("UserWhoFavoriteTheHistoryEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
